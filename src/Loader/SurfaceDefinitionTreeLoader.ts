...
export async function loadSurfaceDefinitionTreeFromsurfacesTxt2Yaml(srfsTxt: SY.SurfacesTxt): Promise<ST.SurfaceDefinitionTree>{
  ...
  const descript = await loadSurfaceDescript(_descript);
